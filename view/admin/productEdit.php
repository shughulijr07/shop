    ...
    <div class="" style="">
        ...
        <div class=" " style="">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                         <div class="card-header bg-success text-white text-center" id="success">Updating Product in Store</div>
                         <div class="card-body">
                               <form >
                               <!-- name="addproduct" method="POST" action="../../required/controller.php" -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                           <button id="Updateproduct_btn" type="submit" style="width: 100%;" class="btn btn-success">Update</button>
                                        </div>
                                    </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">Invoice Short Summary</div>
                        <div class="card-body">
