...
$shop_point_sells = $dBcONNECT->connect()->prepare("SELECT * FROM product_store WHERE quantity < 10");
  ...
  <!-- end of nav -->
   ...
   <div class="" style="">
    ...
    <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Stock Level</li>
          <li class="breadcrumb-item">
            ...
            <div class="card-header" style="background-color: white">
              <div class="row">
                <div class="col-md-3" style="color: maroon">
                    ...
                    Stock Level Limit | <?php echo date("l"); ?>
                </div>
                      ...
                      <?php 
                         foreach ($get_shop_point_sells as $get_point) {
                             ...
                             <tr>
                                ...
                                <td id="product_name'.$get_point['product_id'].'" contenteditable>'.$get_point['product_name'].'</td>
                                <td id="product_type'.$get_point['product_id'].'" contenteditable>'.$get_point['product_type'].'</td>
                                <td id="buying_price'.$get_point['product_id'].'" contenteditable>'.$get_point['buying_price'].'</td>
                                <td id="selling_price'.$get_point['product_id'].'" contenteditable>'.$get_point['selling_price'].'</td>
                                <td id="quantity'.$get_point['product_id'].'" contenteditable>'.$get_point['quantity'].'</td>
                                <td id="shop'.$get_point['product_id'].'" >'.$get_point['shop'].'</td>
                                <td> 
                                    <div class="btn-group">
                                      <button product_update_id='.$get_point['product_id'].' type="button" title="Update" class="btn btn-primary item_level_update"><i class="fa fa-refresh"></i></button>
                                      <button product_delete_id='.$get_point['product_id'].' type="button" title="Delete" class="btn btn-danger product_delete"><i class="fa fa-trash"></i></button>
                                    </div> 
                                </td>
                              </tr>  
                             ';
