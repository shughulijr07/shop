            ...
            <div class="card-header" style="background-color: white">
              <div class="row">
                <div class="col-md-4" style="color: maroon">
                    ...
                    Stock Point Selling Price | <?php echo date("l"); ?>
                </div>
                <div class="col-md-6" style="color: maroon">
                  <div class="row">
                    <div class="col-md-6">Total Selling Price: <?php echo number_format($total_selling_price) ?> /= Tshs</div>
                      ...
                      <?php 
                         foreach ($get_shop_point_sells as $get_point) {
                             ...
                             <tr>
                                ...
                                <td><a href="buying_point.php?point='.$get_point['shop'].'" class="btn btn-info">View</a></td>
                              </tr>  
                             ';
                         }
                      ?>
