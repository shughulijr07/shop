    ...
    <div class="" style="">
        ...
        <div class=" " style="">
            ...
            <div class="col-md-3">  </div>
                <div class="col-md-6">
                    <div class="card">
                         <div class="card-header bg-success text-white text-center" id="success">Transfer Product from <?php echo $shop ?> Store</div>
                         <div class="card-body">
                               <form name="transferProduct" method="POST" action="../../required/controller.php">
                               <!-- name="addproduct" method="POST" action="../../required/controller.php" -->
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                           ...
                                           <div class="col-md-4">
                                             <input value="<?php echo $quantity ?>" name="qty"  min="1" max="<?php echo $quantity ?>" type="number" class="form-control" required>
                                           </div>
                                           <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                          <div class="col-md-4">
                                             ...
                                             <input value="<?php echo $expiredate ?>"  name="expiredate" class="form-control" type="date" required>
                                          </div>
                                           <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                           <button name="transferProduct" id="" type="submit" style="width: 100%;" class="btn btn-warning">Transfer</button>
                                        </div>
                                    </div>
