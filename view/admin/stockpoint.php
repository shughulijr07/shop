                    ...
                    <tr>
                      ...
                      <?php 
                         foreach ($get_shop_point_sells as $get_point) {
                             echo '
                             <tr>
                                <td id="shop'.$get_point['product_id'].'" contenteditable>'.$get_point['shop'].'</td>
                                ...
                                <td id="description'.$get_point['product_id'].'" contenteditable>'.$get_point['description'].'</td>
                                ...
                                <td> 
                                    <div class="btn-group">
                                      <button product_update_id='.$get_point['product_id'].' type="button" title="Update" class="btn btn-primary product_update"><i class="fa fa-refresh"></i></button>
